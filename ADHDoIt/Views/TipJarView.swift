...
struct TipJarView: View {
    ...
    var body: some View {
        Section {
            ...
            Text("ADHDoIt is made by one person. If it's helping you, a tip keeps it going — thank you! 💜")
        }
        .task(id: isExpanded) {
        ...
        .alert("Thank you! 💜", isPresented: $store.showThankYou) {
            ...
            Text("Your support genuinely means a lot and helps keep ADHDoIt going.")
        }
        .alert(
