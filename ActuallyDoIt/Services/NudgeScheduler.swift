...
final class NudgeScheduler {
    ...
    private let logger = Logger(subsystem: "com.devinharmse.ActuallyDoIt", category: "NudgeScheduler")
    ...
    private func summaryRequest(droppedCount: Int,
        ...
        content.body = "\(droppedCount) more \(plural) due today — open ActuallyDoIt to see them."
        content.sound = .default
