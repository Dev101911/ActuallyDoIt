...
private enum TutorialStep: CaseIterable, Hashable {
    ...
    var message: String {
        switch self {
        case .welcome:
            return "Forget tasks, or swipe reminders away and never come back? ActuallyDoIt keeps resurfacing the one thing to do next — and nudges you until you've actually done it. Here's the quick tour."
        case .doingNow:
