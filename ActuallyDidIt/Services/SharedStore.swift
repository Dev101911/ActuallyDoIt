...
enum SharedStore {
    ...
    nonisolated static let appGroupID = "group.com.devinharmse.ActuallyDidIt"

    /// The iCloud container backing CloudKit sync (mirrors the app's entitlements).
    nonisolated static let cloudKitContainerIdentifier = "iCloud.com.devinharmse.ActuallyDidIt"

    /// The store file name inside the App Group container.
    nonisolated static let storeFileName = "ActuallyDidIt.store"
