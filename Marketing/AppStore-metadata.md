...
Primary:  `Focus on one thing at a time`   (28)
Alternatives:
- `One task at a time. Done.`   (25)
- `Reminders that don't quit`   (25)
...
`adhd,todo,list,task,reminders,nudge,procrastination,overwhelm,chores,routine,planner,habit,gtd`
...
ONE THING AT A TIME
• A single "Doing now" card keeps you on one task — with a big Done button and a guilt-free "Can't do this now" escape.
• "Up next" shows a short, curated preview of what's coming — never the whole backlog.
• A day-progress ring shows what you've already knocked out today.

NUDGES THAT ACTUALLY WORK
• Choose how hard each task nudges you: Gentle (one morning reminder), Persistent (a few through the day), or Relentless (every hour, 9am–9pm, until it's done).
• Reminders stop the moment you finish — no nagging about things you've already handled.
...
• Going away? Pause a chore so it stops nagging until you're back.

ORGANIZED, LIGHTLY
• Tag tasks (Home, Work, Admin…) and filter down to just what matters.
• Add a time estimate, so you can pick something that fits the time you actually have.
• A Lock Screen Live Activity and Home Screen widget keep your current task in view.

PRIVATE BY DESIGN
• No account, no sign-up, no ads, no tracking.
• Your tasks sync across your devices through your own iCloud.
• Free to use, with an optional tip if it helps you.
...
> • "Pick for me" when you can't decide where to start
> • Recurring chores you can pause while you're away
> • Tags, time estimates, a Lock Screen Live Activity, and private iCloud sync
>
...
## Screenshot captions (already baked into Marketing/final/*)

1. Beat overwhelm — one thing at a time
2. Reminders that don't quit
3. It nudges until you actually did it
4. Just today — nothing more
